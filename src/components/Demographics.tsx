      ...
      <div className="max-w-7xl mx-auto">
          ...
          {radiusData.map((data, index) => (
            <div key={index} className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-8">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-semibold text-primary mb-2">{data.radius} {t('demographics.radius')}</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center p-4 bg-muted/30 rounded-lg">
                  <div className="flex items-center">
                    ...
                    <span className="text-sm text-muted-foreground">{t('demographics.averageAge')}</span>
                  </div>
                  <span className="text-lg font-bold text-amber-500">{data.avgAge} {t('demographics.years')}</span>
                </div>
        ...
        <div className="bg-gradient-to-r from-gold/10 to-emerald-500/10 rounded-xl p-8">
          <div className="text-center mb-8">
            <h3 className="text-2xl font-semibold text-primary mb-4">{t('demographics.currentMarketTitle')}</h3>
            <p className="text-muted-foreground max-w-4xl mx-auto">
              {t('demographics.currentMarketDescription')}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-card/30 rounded-lg">
              ...
              <div className="text-sm text-muted-foreground">{t('demographics.averageAgeDesc')}</div>
            </div>
            <div className="text-center p-6 bg-card/30 rounded-lg">
              <DollarSign className="h-8 w-8 text-emerald-500 mx-auto mb-3" />
              <div className="text-2xl font-bold text-emerald-500 mb-2">$72K</div>
              <div className="text-sm text-muted-foreground">{t('demographics.householdIncomeDesc')}</div>
            </div>
            <div className="text-center p-6 bg-card/30 rounded-lg">
              <Home className="h-8 w-8 text-blue-500 mx-auto mb-3" />
              <div className="text-2xl font-bold text-blue-500 mb-2">$177K</div>
              <div className="text-sm text-muted-foreground">{t('demographics.homeValueDesc')}</div>
            </div>
          </div>
        </div>
      </div>
